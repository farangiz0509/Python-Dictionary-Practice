...
def run_functions() -> None:
    ...
    """
    print("Full Names:", get_full_names(main.randomuser_data))
    print("Names and Emails:", get_users_by_country(main.randomuser_data, 'India'))
    print("Gender counts:", count_users_by_gender(main.randomuser_data))
    print("Older people's emails:", get_emails_of_older_than(main.randomuser_data, 60))
    print("Users sorted by age (ascending):", sort_users_by_age(main.randomuser_data))
    print("Users sorted by age (descending):", sort_users_by_age(main.randomuser_data, descending=True))
    print("Username by first letter:", get_usernames_starting_with(main.randomuser_data, "a"))
    print("Average age: ", get_average_age(main.randomuser_data))
    print("Group by nationality", group_users_by_nationality(main.randomuser_data))
    print("All user coordinates:", get_all_coordinates(main.randomuser_data))
    print("Oldest user info:", get_oldest_user(main.randomuser_data))
    print("Users in timezone +5:30:", find_users_in_timezone(main.randomuser_data, "+5:30"))
    print("Users registered before 2010:", get_registered_before_year(main.randomuser_data, 2010))
